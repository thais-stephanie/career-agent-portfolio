...
const EN = {
  ...
  'view.cards': 'Cards',
  'view.table': 'Table',
  'export.goodStrong': 'Export GOOD + STRONG',
  'export.working': 'Preparing the file...',
  'export.done': 'Saved {n} GOOD and STRONG postings as a CSV file.',
  'export.failed': 'The file could not be made. Try again.',
  'view.board': 'Board',
  ...
  'profiles.menuLabel': 'Local profiles',
  'profiles.onThisComputer': 'Profiles on this computer',
  'profiles.listLabel': 'Profiles on this computer',
  'profiles.openNow': 'Open now',
  'profiles.createdOn': 'Created {date}',
  'profiles.switch': 'Switch',
  'profiles.switchTo': 'Switch to {name}',
  'profiles.switching': 'Switching...',
  'profiles.renameThis': 'Rename this profile',
  'profiles.save': 'Save',
  'profiles.renamed': 'Renamed.',
  'profiles.newAction': 'New profile',
  'profiles.newLabel': 'New profile',
  'profiles.newPlaceholder': 'e.g. Ana, career change',
  'profiles.newHint': 'Starts empty. Nothing is copied from this profile.',
  'profiles.create': 'Create profile',
  'profiles.cancel': 'Cancel',
  'profiles.privacyShort':
    'Profiles keep CVs, evidence and applications apart. They are not accounts: anyone on this '
    + 'computer can open them.',
  ...
  'sidenav.statusOpenSources': 'Open Settings & Sources to see what went wrong',
  'modeTag.PERSONAL': 'Personal',
  'modeTag.DEMO': 'Demo',
  ...
  'setup.later': 'Finish setup later',
  'setup.back': 'Back',
  ...
  'setup.stepState.upcoming': 'upcoming',
  'setup.step.work': 'Work',
  'setup.step.roles': 'Roles',
  'setup.step.home': 'Where you live',
  'setup.step.hire': 'Hiring',
  'setup.step.regions': 'Regions',
  'setup.step.workmodel': 'Work model',
  'setup.step.arrangement': 'Contract',
  'setup.step.level': 'Levels',
  'setup.step.pay': 'Pay',
  'setup.step.cv': 'CV',
  'setup.step.review': 'Review',
  'setup.roles.continueOne': 'Continue with 1 role',
  'setup.roles.continueMany': 'Continue with {n} roles',
  'roles.label': 'Your roles',
  'roles.hint': 'Type a title and press Enter.',
  'roles.placeholder': 'e.g. Account Executive',
  'roles.suggestions': 'From your Career Profile',
  'roles.add': 'Add {role}',
  'roles.suggestionsNote': 'Roles you\'ve held. Add one only if you want to do it again.',
...
const PT_BR = {
  ...
  'view.cards': 'Cartões',
  'view.table': 'Tabela',
  'export.goodStrong': 'Exportar GOOD + STRONG',
  'export.working': 'Preparando o arquivo...',
  'export.done': '{n} vagas GOOD e STRONG salvas em um arquivo CSV.',
  'export.failed': 'Não foi possível criar o arquivo. Tente de novo.',
  'view.board': 'Quadro',
  ...
  'profiles.menuLabel': 'Perfis locais',
  'profiles.onThisComputer': 'Perfis neste computador',
  'profiles.listLabel': 'Perfis neste computador',
  'profiles.openNow': 'Aberto agora',
  'profiles.createdOn': 'Criado em {date}',
  'profiles.switch': 'Trocar',
  'profiles.switchTo': 'Trocar para {name}',
  'profiles.switching': 'Trocando...',
  'profiles.renameThis': 'Renomear este perfil',
  'profiles.save': 'Salvar',
  'profiles.renamed': 'Renomeado.',
  'profiles.newAction': 'Novo perfil',
  'profiles.newLabel': 'Novo perfil',
  'profiles.newPlaceholder': 'ex.: Ana, mudança de carreira',
  'profiles.newHint': 'Começa vazio. Nada deste perfil é copiado.',
  'profiles.create': 'Criar perfil',
  'profiles.cancel': 'Cancelar',
  'profiles.privacyShort':
    'Perfis mantêm currículos, evidências e candidaturas separados. Não são contas: qualquer pessoa '
    + 'neste computador pode abri-los.',
  ...
  'sidenav.statJobs': 'vagas encontradas',
  'sidenav.statOpen': 'em aberto',
  'sidenav.statInterview': 'entrevistas',
  'sidenav.statusOk': 'Todas as fontes funcionando',
  'sidenav.statusAttentionOne': '1 fonte precisa de atenção',
  'sidenav.statusAttention': '{n} fontes precisam de atenção',
  'sidenav.statusOpenSources': 'Abrir Configurações e fontes para ver o que deu errado',
  'modeTag.PERSONAL': 'Pessoal',
  'modeTag.DEMO': 'Demo',
  ...
  'setup.later': 'Terminar a configuração depois',
  'setup.back': 'Voltar',
  ...
  'roles.remove': 'Remover {role}',
  'roles.addShort': '+ Adicionar',
  ...
  'setup.stepState.done': 'concluída',
  'setup.stepState.current': 'etapa atual',
  'setup.stepState.upcoming': 'a seguir',
  'setup.step.work': 'Trabalho',
  'setup.step.roles': 'Cargos',
  'setup.step.home': 'Onde mora',
  'setup.step.hire': 'Países',
  'setup.step.regions': 'Regiões',
  'setup.step.workmodel': 'Modelo',
  'setup.step.arrangement': 'Vínculo',
  'setup.step.level': 'Níveis',
  'setup.step.pay': 'Salário',
  'setup.step.cv': 'Currículo',
  'setup.step.review': 'Revisão',
  'setup.roles.continueOne': 'Continuar com 1 cargo',
  'setup.roles.continueMany': 'Continuar com {n} cargos',
  'roles.label': 'Seus cargos',
  'roles.hint': 'Digite um cargo e pressione Enter.',
  'roles.placeholder': 'ex.: Executivo de Contas',
  'roles.suggestions': 'Do seu Perfil de Carreira',
  'roles.add': 'Adicionar {role}',
  'roles.suggestionsNote': 'Cargos que você já ocupou. Adicione um só se quiser fazer isso de novo.',
