...
const EN = {
  ...
  'cv.discard': 'Throw away this read',
  'cv.discardConfirm': 'Throw away this read of {name}?\n\n{pending} unanswered proposals go. '
    + 'The {confirmed} facts you already confirmed are kept -- they stopped belonging to this '
    + 'document the moment you confirmed them.',
  'cv.backToEvidence': 'Back to your evidence',
  'cv.reviewHeading': 'What {name} appears to say',
  'cv.reviewLede': '{pending} of {total} still to answer.',
  'cv.reviewDone': 'All {total} answered.',
  ...
  'pagehead.title.evidence': 'Your career evidence',
...
const PT_BR = {
  ...
  'cv.discard': 'Descartar esta leitura',
  'cv.discardConfirm': 'Descartar esta leitura de {name}?\n\n{pending} propostas sem '
    + 'resposta vão embora. Os {confirmed} fatos que você já confirmou ficam -- eles '
    + 'deixaram de pertencer a este documento no momento em que você os confirmou.',
  'cv.backToEvidence': 'Voltar às suas evidências',
  'cv.reviewHeading': 'O que {name} parece dizer',
  'cv.reviewLede': '{pending} de {total} ainda por responder.',
  'cv.reviewDone': 'Todas as {total} respondidas.',
  ...
  'nav.evidence': 'Evidências de carreira',
